<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="solicitudesAdd.aspx.cs" Inherits="despacho.solicitudesAdd" %>
                            ...
                            <form id="defaultForm" method="post">
                                    ...
                                    <div class="row gutter">
                                        ...
                                        <asp:Panel ID="Panel4" runat="server">
                                            ...
                                            <div class="row gutter">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:Button ID="btnAgregarDetalle" runat="server" OnClick="btnAgregarDetalle_Click" Text="Agregar Solicitud" data-dismiss="modal" 
                                                                                                        data-target=".bd-example-modal-sm" class="btn btn-success" />
                                                    <%--<asp:Button ID="btnAgregarDetalle" runat="server" OnClick="btnAgregarDetalle_Click" Text="Agregar Producto(s)" class="btn btn-info" />--%>
                                                </div>
                                            </div>
                                        </asp:Panel>
                                    </div>
                                ...
                                <asp:Panel ID="pnlDetalleProductos" runat="server" BorderWidth="1px" Visible="False">
                                    ...
                                    <div class="row gutter">
                                        ...
                                        <div class="col-md-1">
                                            <br />
                                            <asp:Button ID="btnInsertarProducto" runat="server" Text="Insertar" class="btn btn-info" data-dismiss="modal"  data-target=".bd-example-modal-sm" OnClick="btnInsertarProducto_Click" />
